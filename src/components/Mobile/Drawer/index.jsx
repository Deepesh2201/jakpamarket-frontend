            ...
            <div className="flex justify-between items-center">
              <div className="flex space-x-5 items-center">
                <div className="compaire relative">
                  ...
                  <span className="w-[18px] h-[18px] rounded-full text-qblack bg-qyellow absolute -top-2.5 -right-2.5 flex justify-center items-center text-[9px]">
